...
public class GatewayController {
    ...
    public static BigInteger convertUsdToXmr(Float usdTotal) {
        return BigInteger.valueOf(1000000000000l);
    }

    @PostMapping(path = "/v1/monero/ecwid")
    public String onPayment(@RequestBody(required = true) EcwidPaymentData paymentData, Model model) {
